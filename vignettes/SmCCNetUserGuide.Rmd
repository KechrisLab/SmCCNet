...
<!-- If you are working with high-throughput sequencing (RNASeq) data, we recommend to first address heteroscedasticity. -->
...
knitr::kable(read.csv("Example3foldCV/TotalPredictionError.csv"), caption = "Total Prediction Error from a 3-fold CV for the synthetic dataset")
```
...
knitr::include_graphics("Example3foldCV/TotalPredictionError.pdf")
```
...
```{r, echo = FALSE}
load("Example3foldCV/SmCCNetWeights.Rdata")
```
...
knitr::include_graphics("Example3foldCV/Net_1.pdf")
```
